$(document).ready(function () {
  ...
  function cargarImagenes() {
    ...
    $("#tabla-aves tbody tr").each(function () {
      var enlaceImagen = $(this).find("td:last-child a").attr("href");
      var extension = enlaceImagen.split(".").pop().toLowerCase();
      if (extension === "jpg" || extension === "jpeg") {
        var imagenHtml =
          '<img class="imagen-tabla" src="' + enlaceImagen + '" alt="Imagen">';
        $(this).find("td:last-child").empty(); // Eliminar contenido existente
        $(this).append("<td>" + imagenHtml + "</td>"); // Agregar imagen en nueva celda
        console.log("Imagen cargada:", enlaceImagen);
      }
    });
  }
